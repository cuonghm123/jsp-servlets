document.addEventListener(
						...
						function() {
							...
							Validator({
								...
								rules : [
										Validator.isRequired('#null-input',
												'Missing required !!!'),
		...
		function Validator(options) {
			...
			function validate(inputElement, rule) {
				var errorElement = getParent(inputElement,
						options.formGroupSelector).querySelector(
				...
				for (var i = 0; i < rules.length; ++i) {
					...
					case 'radio':
					case 'checkbox':
						errorMessage = rules[i](formElement
								.querySelector(rule.selector + ':checked'));
						break;
					default:
