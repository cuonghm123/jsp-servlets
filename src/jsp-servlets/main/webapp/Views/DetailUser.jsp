       ...
       <input type="hidden" id="form2Example1" class="form-control" value="${st.id}"
        ...
        <div class="form-outline mb-4">
          ...
          <div class="gender" >
            ...
            value="1" ${st.gender == 1 ? "checked" : ""} name="gender" />Nu 
            <input type="radio" id="form2Example1"
						class="form-control" value="0" ${st.gender == 0 ? "checked" : ""} name="gender" />Nam
        ...
        <div class="form-outline mb-4">
          <input type="text" id="form2Example1" class="form-control" value="${st.address}"
            name="address" /> <label class="form-label" for="form2Example1"></label>
        </div>
        <div class="form-outline mb-4">
          <input type="text" id="form2Example1" class="form-control" value="${st.room}"
            name="room" /> <label class="form-label" for="form2Example1"></label>
        </div>
      </form>
	</div>
